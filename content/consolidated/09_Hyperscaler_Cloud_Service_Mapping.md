...
| **MCP (Model Context Protocol)** | **Google Cloud MCP servers** (ADC, IAM, Agent Engine, OAuth client ID, API keys); **Cloud API Registry** (MCP catalog, registry-first tools, IAM: cloudapiregistry.viewer, mcp.toolUser); **Apigee API hub** (register MCP APIs, import to Cloud API Registry); **Cloud Run** (MCP runtime); **Apigee** (MCP front door, API Products, Developer Portal); **Model Armor** (MCP sanitization, prompt injection/jailbreak protection) | _To be filled_ | _To be filled_ |
...
| 11 | Cloud API Registry overview | [Google Cloud](https://docs.cloud.google.com/api-registry/docs/overview) | `content/ingested/governance/gcp-cloud-api-registry-overview.md` |
| 12 | Register MCP APIs (Apigee API hub) | [Google Cloud](https://docs.cloud.google.com/apigee/docs/apihub/register-mcp-apis) | `content/ingested/governance/apigee-api-hub-register-mcp-apis.md` |
| 13 | AI security and safety (MCP) | [Google Cloud](https://docs.cloud.google.com/mcp/ai-security-safety) | `content/ingested/governance/gcp-mcp-ai-security-safety.md` |
| 14 | Model Armor integration with Google Cloud MCP servers | [Google Cloud](https://docs.cloud.google.com/model-armor/model-armor-mcp-google-cloud-integration) | `content/ingested/governance/model-armor-mcp-integration.md` |
